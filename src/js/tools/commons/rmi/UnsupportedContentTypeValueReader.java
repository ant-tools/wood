...
/**
 * Unsupported content type on HTTP-RMI response. We reach this point for not anticipated exceptional conditions. Dump
 * response stream as string to system error using UTF-8 and returns null; of course there is the risk that dump to be
 * not intelligible.
 * 
